...
<link rel="stylesheet" type ="text/css" media="screen" href="../assets/css/manageproduct.css">
...
<div class ="main">
    ...
    <form  action="../controller/manage.controller.php" method="POST">
...
<br><br>
<label>Item Code<input style="margin-left:84px;"type ="text" name="productcode" placeholder="Item code"></label><br><br>
...
<button class="primary"type = "update" name="update">update</button>
<button  class="danger"type = "delete"name="delete">Delete</button>
<input  class="success"type = "submit" value="submit" name="submit">
<a href="../view/allitems.view.php">Show Items</a>
</form>
</div>
</div>
